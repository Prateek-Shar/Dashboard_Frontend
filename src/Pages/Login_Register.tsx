    ...
    return (
        ...
        <div className="xl:w-screen xl:h-screen bg-[#a8b0ff] flex justify-center items-center ml:w-full ml:h-screen ml:justify-normal mm:w-full mm:h-full mm:justify-normal mm:py-13">
            ...
            <div className="w-[90%] flex justify-center items-center">
                ...
                <div className="absolute xl:top-30 xl:left-82 xl:w-[63%] xl:h-[75%] bg-[#e4e7f4] rounded-xl shadow-lg z-0 ml:top-23 ml:left-3 ml:w-[88%] ml:h-[80%] mm:top-23 mm:left-3 mm:w-[88%] mm:h-[80%]" />
                <div className="absolute xl:top-22 xl:left-87 xl:w-[61%] xl:h-[81%] bg-[#e4e7f4] rounded-xl shadow-xl z-10 ml:top-22 ml:left-5 ml:w-[87%] ml:h-[81%] mm:top-22 mm:left-5 mm:w-[87%] mm:h-[81%]" />

            
                <div className="relative z-20 xl:ml-35 xl:w-[70%] xl:h-[90%] rounded-2xl shadow-2xl flex bg-[#e8ecf8] ml:w-[95%] ml:ml-5 mm:ml-5 mm:w-[95%]">
                    
                    <div className="xl:w-[40%] p-10 xl:flex flex-col justify-evenly ml:hidden mm:hidden"> 
                        <div className="w-[80%]">
                    ...
                    <UserProvider>
                        {handleDefault && (
                        <div className="xl:w-[60%] bg-[#f8f9ff] rounded-2xl flex flex-col items-center ml:w-full mm:w-full">
