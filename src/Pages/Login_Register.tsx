...
const Login_Register = () => {
    ...
    return (
        ...
        <div className="xl:w-screen xl:h-screen bg-[#a8b0ff] flex justify-center items-center ml:w-full ml:h-screen ml:justify-normal">

            <div className="w-[90%] flex justify-center items-center">
            
                <div className="absolute top-20 left-82 w-[63%] h-[86%] bg-[#e4e7f4] rounded-xl shadow-lg z-0 ml:top-23 ml:left-3 ml:w-[88%] ml:h-[80%]" />
                <div className="absolute top-10 left-93 w-[63%] h-[86%] bg-[#e4e7f4] rounded-xl shadow-xl z-10 ml:top-22 ml:left-5 ml:w-[87%] ml:h-[81%]" />

            
                <div className="relative z-20 w-[70%] h-[90%] rounded-2xl shadow-2xl flex bg-[#e8ecf8] ml:w-[95%] ml:ml-5">
                    
                    <div className="w-[40%] p-10 flex flex-col justify-evenly ml:hidden">
                        <div className="w-[80%]">
