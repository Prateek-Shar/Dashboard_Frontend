    ...
    return (
        ...
        <div className="xl:w-full bg-[#edede9] ml:w-[90%] mm:w-[90%]">
            ...
            <div className="w-full flex justify-evenly items-center mt-15 ml:mt-5 mm:mt-5">
                ...
                <div className="w-[40%] flex flex-col bg-white rounded-4xl shadow-lg mt-10 mb-10 ml:w-[80%] mm:w-[75%] mm:rounded-3xl">
                    <div className="w-full flex justify-center mb-2 mt-3">
                        <p className="font-Poppins text-[#9197b3] ml:text-[10px] mm:text-[10px]">Total Income as Per Catagory</p>
                    </div>
                ...
                <div className="w-[20%] flex flex-col bg-white rounded-4xl shadow-lg mt-10 mb-10 ml:hidden mm:hidden">
                    <div className="w-full flex justify-center mb-2 mt-3">
            ...
            <div className="xl:hidden ml:flex w-full justify-center items-center mm:flex">
                <div className="w-[80%] flex flex-col bg-white rounded-3xl shadow-lg mt-10 mb-10">
                    <div className="w-full flex justify-center mb-2 mt-3">
                        <p className="font-Poppins text-[#9197b3] ml:text-[10px] mm:text-[10px]">Total Customers as per Country</p>
                    </div>
            ...
            <div className="w-full flex justify-evenly items-center mt-10 ml:justify-center ml:mt-0 mm:mt-0">
                <div className="w-[40%] bg-white mt-10 mb-10 rounded-4xl shadow-lg ml:w-[80%] mm:w-[80%]">
                    <Latest_Transaction />
                </div>

                <div className="w-[40%] bg-white mt-10 mb-10 rounded-3xl shadow-lg ml:w-[50%] ml:hidden mm:hidden">
                    <Alerts_Box />
                </div>
            </div>

            <div className="ml:flex xl:hidden justify-center items-center mm:flex">
                <div className="bg-white mt-10 mb-10 rounded-3xl shadow-lg w-[80%]">
                    <Alerts_Box />
                </div>
            </div>
