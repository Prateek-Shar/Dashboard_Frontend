...
const Product_table = () => {
    ...
    <>
        ...
        {showTable && (
            <>
            {productCount > 0 ? (
                <div className="w-[85%] flex flex-col justify-center shadow-lg items-center rounded-3xl">
                    ...
                    <div className="w-[95%] flex justify-between items-center my-5">
                        ...
                        <div className="xl:w-[20%] ml:w-[40%] mm:w-[40%] flex items-center">
                    ...
                    <div className="w-full ml:hidden mm:hidden xl:flex flex-col items-center">
                    ...
                    <div className="w-full flex justify-center items-center flex-col">
                                ...
                                productDet.map((product , key) => {
                                    ...
                                    return (
                                        <div key={product.P_id} className="w-full flex xl:flex-row ml:flex-col mm:flex-col py-2">
                                            ...
                                            <div className="xl:w-[15%] ml:w-full mm-w-full xl:ml-5 ml:ml-5 mm:ml-5 ml:py-1 mm:my-1 flex xl:justify-center ml:justify-normal items-center">
                                            ...
                                            <div className="xl:w-[15%] ml:w-full mm:w-full xl:ml-5 ml:ml-5 mm:ml-5 xl:py-1 ml:py-1 mm:py-1 flex xl:justify-center ml:justify-normal items-center">
                                                <p className="font-Poppins text-[#495057]">
                                                    {Number(product.Product_quantity) <= 0 ? "Out of Stock" : "In Stock"}
                                                </p>
                                            </div>
                                            <div className="w-[15%] ml-4 xl:flex ml:hidden mm:hidden justify-center items-center">
                        ...
                        <div className="w-[95%] flex justify-between items-center">
                            <p className='font-Poppins text-[#d9d2d7] xl:text-[13px] ml:text-[11px] mm:text-[11px]'>
